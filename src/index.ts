...
import { ChangeEventPayload, ReactNativeUiKitViewProps } from './ReactNativeUiKit.types';
...
const emitter = new EventEmitter(ReactNativeUiKitModule ?? NativeModulesProxy.ReactNativeUiKit);
